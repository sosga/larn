...
*  printw(str)         sent string to output buffer
*
*  FILE OUTPUT MACROS
*
...
static int ipoint = MAXIBUF,
           iepoint = MAXIBUF;	/*  input buffering pointers    */
static char
lgetwbuf[LINBUFSIZE];	/* get line (word) buffer               */
...
/*
*  printw(string)                  append a string to the output buffer
